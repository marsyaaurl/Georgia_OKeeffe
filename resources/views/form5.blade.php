...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/form5.css')}}">
        ...
        <form id="ticketForm">
            ...
            <div class="form-group quantity-group">
                ...
                <div class="quantity">
                    ...
                    <input type="number" id="quantity" class="input-box" value="1" min="1" max="10">
                    <button type="button" class="plus" aria-label="Increase">&plus;</button>
                </div>
            </div>
            <div class="total-container">
                <span class="total-label">Total</span>
                <span type="number" id="total-amount" data-price="12.00">$12.00</span>
            </div>
            <div class="form-group">
